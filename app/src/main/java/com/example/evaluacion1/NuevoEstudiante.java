        ...
        btnGuardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(edtNombre.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(NuevoEstudiante.this, "El campo primer parcial no esta lleno",Toast.LENGTH_LONG).show();
                }else if(edtParcial2.getText().toString().isEmpty()){
                    Toast.makeText(NuevoEstudiante.this, "El campo segundo parcial no esta lleno",Toast.LENGTH_LONG).show();
                }else if(edtParcial3.getText().toString().isEmpty()){
                    Toast.makeText(NuevoEstudiante.this, "El campo tercer parcial no esta lleno",Toast.LENGTH_LONG).show();
                }else{
                    GuardarEstudiante();
                    corr++;
                }
